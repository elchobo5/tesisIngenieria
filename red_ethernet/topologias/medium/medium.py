...
class CustomTopology( Topo ):
  def __init__( self ):
    ...
    switch46 = self.addHost('switch46', ips=['192.168.1.56/24','10.24.48.2/24','10.50.0.2/24'],
        ...
        border=1, ce_ip_address='10.50.0.1', ce_mac_address='00:00:00:00:00:03',
        cls=RAUSwitch)
    ...
    switch47 = self.addHost('switch47', ips=['192.168.1.57/24','10.47.47.2/24','10.50.1.2/24'],
        ...
        border=1, ce_ip_address='10.50.1.1', ce_mac_address='00:00:00:00:00:04',
        cls=RAUSwitch)
    ...
    switch48 = self.addHost('switch48', ips=['192.168.1.58/24','10.48.48.2/24','10.50.2.2/24'],
        ...
        border=1, ce_ip_address='10.50.2.1', ce_mac_address='00:00:00:00:00:05',
        cls=RAUSwitch)
    ...
    switch49 = self.addHost('switch49', ips=['192.168.1.59/24','10.49.49.2/24','10.50.3.2/24'],
        ...
        border=1, ce_ip_address='10.50.3.1', ce_mac_address='00:00:00:00:00:06',
        cls=RAUSwitch)
    ...
    switch50 = self.addHost('switch50', ips=['192.168.1.60/24','10.50.50.2/24','10.50.4.2/24'],
        ...
        border=1, ce_ip_address='10.50.4.1', ce_mac_address='00:00:00:00:00:07',
        cls=RAUSwitch)
    ...
    switch51 = self.addHost('switch51', ips=['192.168.1.61/24','10.51.51.2/24','10.50.5.2/24'],
        ...
        border=1, ce_ip_address='10.50.5.1', ce_mac_address='00:00:00:00:00:08',
        cls=RAUSwitch)
    ...
    switch52 = self.addHost('switch52', ips=['192.168.1.62/24','10.52.52.2/24','10.50.6.2/24'],
        ...
        border=1, ce_ip_address='10.50.6.1', ce_mac_address='00:00:00:00:00:09',
        cls=RAUSwitch)
